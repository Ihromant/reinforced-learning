...
public class Main {
     private static AITemplate<TTTAction> template = new MinimaxTemplate<>(Player.O);
//    private static AITemplate<TTTAction> template = new QLearningTemplate<>(new TicTacToeState(),
//            new MapQTable<>(0.3), 10000, 10);
    public static void main(String[] args) {
        new GameBoard<>(template, new TicTacToePlayer(new Scanner(System.in)), TicTacToeState::new).play();
    }
}
